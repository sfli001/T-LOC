...
if(os.path.exists("%s/%s_mosaic_REF_TDNA.txt" % (REF_path, Sample_name) )):
    ...
    cmd = "Rscript %s/Coverage_bam.R  %s/%s_mosaic_REF_TDNA.txt  %s %s/Cov_%s_FromREF.pdf %s %s" % (bin_path,REF_path,Sample_name,bamR, Result_path,Sample_name, REF_path, Sample_name)
    logging.debug(cmd)
    os.system(cmd)
...
cmd = "Rscript %s/Coverage_bam.R  %s/%s_mosaic_REF_TDNA.txt  %s %s/Cov_%s_FromTDNA.pdf %s %s" % (bin_path,TDNA_path,Sample_name,bamR, Result_path,Sample_name, TDNA_path,Sample_name)
logging.debug(cmd)
os.system(cmd)
